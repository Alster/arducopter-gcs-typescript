...
SensorOffsets.FIELDS = [
    new mavlink_1.MavLinkPacketField('magDeclination', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('rawPress', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('rawTemp', 8, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('gyroCalX', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('gyroCalY', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('gyroCalZ', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('accelCalX', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('accelCalY', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('accelCalZ', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('magOfsX', 36, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('magOfsY', 38, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('magOfsZ', 40, false, 2, 'int16_t'),
];
/**
...
SetMagOffsets.FIELDS = [
    new mavlink_1.MavLinkPacketField('magOfsX', 0, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('magOfsY', 2, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('magOfsZ', 4, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 6, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 7, false, 1, 'uint8_t'),
];
/**
 * State of APM memory.
 */
...
MemInfo.FIELDS = [
    new mavlink_1.MavLinkPacketField('brkval', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('freemem', 2, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('freemem32', 4, true, 4, 'uint32_t'),
];
/**
 * Raw ADC output.
 */
...
ApAdc.FIELDS = [
    new mavlink_1.MavLinkPacketField('adc1', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('adc2', 2, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('adc3', 4, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('adc4', 6, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('adc5', 8, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('adc6', 10, false, 2, 'uint16_t'),
];
/**
...
DigicamConfigure.FIELDS = [
    new mavlink_1.MavLinkPacketField('extraValue', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('shutterSpeed', 4, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 6, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 7, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('mode', 8, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('aperture', 9, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('iso', 10, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('exposureType', 11, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('commandId', 12, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('engineCutOff', 13, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('extraParam', 14, false, 1, 'uint8_t'),
];
/**
...
DigicamControl.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('session', 6, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('zoomPos', 7, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('zoomStep', 8, false, 1, 'int8_t'),
    new mavlink_1.MavLinkPacketField('focusLock', 9, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('shot', 10, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('commandId', 11, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('extraParam', 12, false, 1, 'uint8_t'),
];
/**
...
MountConfigure.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('mountMode', 2, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('stabRoll', 3, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('stabPitch', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('stabYaw', 5, false, 1, 'uint8_t'),
];
/**
...
MountControl.FIELDS = [
    new mavlink_1.MavLinkPacketField('inputA', 0, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('inputB', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('inputC', 8, false, 4, 'int32_t'),
    ...
    new mavlink_1.MavLinkPacketField('savePosition', 14, false, 1, 'uint8_t'),
];
/**
...
MountStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('pointingA', 0, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('pointingB', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('pointingC', 8, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 12, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 13, false, 1, 'uint8_t'),
];
/**
...
FencePoint.FIELDS = [
    new mavlink_1.MavLinkPacketField('lat', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('lng', 4, false, 4, 'float'),
    ...
    new mavlink_1.MavLinkPacketField('idx', 10, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('count', 11, false, 1, 'uint8_t'),
];
/**
...
FenceFetchPoint.FIELDS = [
    new mavlink_1.MavLinkPacketField('targetSystem', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('idx', 2, false, 1, 'uint8_t'),
];
/**
...
Ahrs.FIELDS = [
    new mavlink_1.MavLinkPacketField('omegaIx', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('omegaIy', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('omegaIz', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('accelWeight', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('renormVal', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('errorRp', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('errorYaw', 24, false, 4, 'float'),
];
/**
...
SimState.FIELDS = [
    new mavlink_1.MavLinkPacketField('roll', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pitch', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yaw', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('xacc', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yacc', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('zacc', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('xgyro', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('ygyro', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('zgyro', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('lat', 36, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('lng', 40, false, 4, 'int32_t'),
];
/**
...
HwStatus.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('I2Cerr', 2, false, 1, 'uint8_t'),
];
/**
...
LimitsStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('lastTrigger', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('lastAction', 4, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('lastRecovery', 8, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('lastClear', 12, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('breachCount', 16, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('limitsState', 18, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('modsEnabled', 19, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('modsRequired', 20, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('modsTriggered', 21, false, 1, 'uint8_t'),
];
/**
 * Wind estimation.
 */
...
Wind.MAGIC_NUMBER = 1;
Wind.FIELDS = [
    new mavlink_1.MavLinkPacketField('direction', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('speed', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('speedZ', 8, false, 4, 'float'),
];
/**
 * Data packet, size 16.
 */
...
Data16.FIELDS = [
    new mavlink_1.MavLinkPacketField('type', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('len', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('data', 2, false, 1, 'uint8_t[]', 16),
];
/**
 * Data packet, size 32.
 */
...
Data32.FIELDS = [
    new mavlink_1.MavLinkPacketField('type', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('len', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('data', 2, false, 1, 'uint8_t[]', 32),
];
/**
 * Data packet, size 64.
 */
...
Data64.FIELDS = [
    new mavlink_1.MavLinkPacketField('type', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('len', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('data', 2, false, 1, 'uint8_t[]', 64),
];
/**
 * Data packet, size 96.
 */
...
Data96.FIELDS = [
    new mavlink_1.MavLinkPacketField('type', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('len', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('data', 2, false, 1, 'uint8_t[]', 96),
];
/**
...
RangeFinder.FIELDS = [
    new mavlink_1.MavLinkPacketField('distance', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('voltage', 4, false, 4, 'float'),
];
/**
...
AirspeedAutocal.FIELDS = [
    new mavlink_1.MavLinkPacketField('vx', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vy', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vz', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('diffPressure', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('EAS2TAS', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('ratio', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('stateX', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('stateY', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('stateZ', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('Pax', 36, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('Pby', 40, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('Pcz', 44, false, 4, 'float'),
];
/**
...
RallyPoint.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('lng', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('alt', 8, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('breakAlt', 10, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('landDir', 12, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 14, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 15, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('idx', 16, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('count', 17, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('flags', 18, false, 1, 'uint8_t'),
];
/**
...
CompassMotStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('current', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('CompensationX', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('CompensationY', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('CompensationZ', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('throttle', 16, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('interference', 18, false, 2, 'uint16_t'),
];
/**
...
Ahrs2.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('pitch', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yaw', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('altitude', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('lat', 16, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('lng', 20, false, 4, 'int32_t'),
];
/**
 * Camera Event.
 */
...
CameraStatus.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('p1', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('p2', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('p3', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('p4', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('imgIdx', 24, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 26, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('camIdx', 27, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('eventId', 28, false, 1, 'uint8_t'),
];
/**
...
CameraFeedback.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('lng', 12, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('altMsl', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('altRel', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('roll', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pitch', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yaw', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('focLen', 36, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('imgIdx', 40, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 42, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('camIdx', 43, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('flags', 44, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('completedCaptures', 45, true, 2, 'uint16_t'),
];
/**
 * 2nd Battery status
 *
...
Battery2.FIELDS = [
    new mavlink_1.MavLinkPacketField('voltage', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('currentBattery', 2, false, 2, 'int16_t'),
];
/**
...
Ahrs3.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('lat', 16, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('lng', 20, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('v1', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('v2', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('v3', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('v4', 36, false, 4, 'float'),
];
/**
...
RemoteLogDataBlock.FIELDS = [
    new mavlink_1.MavLinkPacketField('seqno', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 5, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('data', 6, false, 1, 'uint8_t[]', 200),
];
/**
...
LedControl.FIELDS = [
    new mavlink_1.MavLinkPacketField('targetSystem', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('instance', 2, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('pattern', 3, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('customLen', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('customBytes', 5, false, 1, 'uint8_t[]', 24),
];
/**
...
MagCalProgress.FIELDS = [
    new mavlink_1.MavLinkPacketField('directionX', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('directionY', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('directionZ', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('compassId', 12, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('calMask', 13, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('calStatus', 14, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('attempt', 15, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('completionPct', 16, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('completionMask', 17, false, 1, 'uint8_t[]', 10),
];
/**
...
EkfStatusReport.FIELDS = [
    new mavlink_1.MavLinkPacketField('velocityVariance', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('posHorizVariance', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('posVertVariance', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('compassVariance', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('terrainAltVariance', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('flags', 20, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('airspeedVariance', 22, true, 4, 'float'),
];
/**
...
PidTuning.FIELDS = [
    new mavlink_1.MavLinkPacketField('desired', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('achieved', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('FF', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('P', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('I', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('D', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('axis', 24, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('SRate', 25, true, 4, 'float'),
    new mavlink_1.MavLinkPacketField('PDmod', 29, true, 4, 'float'),
];
/**
...
Deepstall.FIELDS = [
    new mavlink_1.MavLinkPacketField('landingLat', 0, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('landingLon', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('pathLat', 8, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('pathLon', 12, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('arcEntryLat', 16, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('arcEntryLon', 20, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('altitude', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('expectedTravelDistance', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('crossTrackError', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('stage', 36, false, 1, 'uint8_t'),
];
/**
...
GimbalReport.FIELDS = [
    new mavlink_1.MavLinkPacketField('deltaTime', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('deltaAngleX', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('deltaAngleY', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('deltaAngleZ', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('deltaVelocityX', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('deltaVelocityY', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('deltaVelocityZ', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('jointRoll', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('jointEl', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('jointAz', 36, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('targetSystem', 40, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 41, false, 1, 'uint8_t'),
];
/**
...
GimbalControl.FIELDS = [
    new mavlink_1.MavLinkPacketField('demandedRateX', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('demandedRateY', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('demandedRateZ', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('targetSystem', 12, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 13, false, 1, 'uint8_t'),
];
/**
...
GimbalTorqueCmdReport.FIELDS = [
    new mavlink_1.MavLinkPacketField('rlTorqueCmd', 0, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('elTorqueCmd', 2, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('azTorqueCmd', 4, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 6, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 7, false, 1, 'uint8_t'),
];
/**
...
GoproHeartbeat.FIELDS = [
    new mavlink_1.MavLinkPacketField('status', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('captureMode', 1, false, 1, 'uint8_t'),
...
GoproGetRequest.FIELDS = [
    new mavlink_1.MavLinkPacketField('targetSystem', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('cmdId', 2, false, 1, 'uint8_t'),
];
/**
...
GoproGetResponse.FIELDS = [
    new mavlink_1.MavLinkPacketField('cmdId', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('status', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('value', 2, false, 1, 'uint8_t[]', 4),
];
/**
...
GoproSetRequest.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('targetComponent', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('cmdId', 2, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('value', 3, false, 1, 'uint8_t[]', 4),
];
/**
...
Rpm.FIELDS = [
    new mavlink_1.MavLinkPacketField('rpm1', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('rpm2', 4, false, 4, 'float'),
];
/**
...
DeviceOpRead.FIELDS = [
    new mavlink_1.MavLinkPacketField('requestId', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 5, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('bustype', 6, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('bus', 7, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('address', 8, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('busname', 9, false, 1, 'char[]', 40),
    new mavlink_1.MavLinkPacketField('regstart', 49, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('count', 50, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('bank', 51, true, 1, 'uint8_t'),
];
/**
...
DeviceOpReadReply.FIELDS = [
    new mavlink_1.MavLinkPacketField('requestId', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('result', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('regstart', 5, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('count', 6, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('data', 7, false, 1, 'uint8_t[]', 128),
    new mavlink_1.MavLinkPacketField('bank', 135, true, 1, 'uint8_t'),
];
/**
...
DeviceOpWrite.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('regstart', 49, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('count', 50, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('data', 51, false, 1, 'uint8_t[]', 128),
    new mavlink_1.MavLinkPacketField('bank', 179, true, 1, 'uint8_t'),
];
/**
...
AdapTuning.FIELDS = [
    new mavlink_1.MavLinkPacketField('desired', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('achieved', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('error', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('theta', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('omega', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('sigma', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('thetaDot', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('omegaDot', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('sigmaDot', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('f', 36, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('fDot', 40, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('u', 44, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('axis', 48, false, 1, 'uint8_t'),
];
/**
...
VisionPositionDelta.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('timeDeltaUsec', 8, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('angleDelta', 16, false, 4, 'float[]', 3),
    new mavlink_1.MavLinkPacketField('positionDelta', 28, false, 4, 'float[]', 3),
    new mavlink_1.MavLinkPacketField('confidence', 40, false, 4, 'float'),
];
/**
...
AoaSsa.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('AOA', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('SSA', 12, false, 4, 'float'),
];
/**
...
EscTelemetry1To4.FIELDS = [
    new mavlink_1.MavLinkPacketField('voltage', 0, false, 2, 'uint16_t[]', 4),
    new mavlink_1.MavLinkPacketField('current', 8, false, 2, 'uint16_t[]', 4),
    new mavlink_1.MavLinkPacketField('totalcurrent', 16, false, 2, 'uint16_t[]', 4),
    new mavlink_1.MavLinkPacketField('rpm', 24, false, 2, 'uint16_t[]', 4),
    new mavlink_1.MavLinkPacketField('count', 32, false, 2, 'uint16_t[]', 4),
    new mavlink_1.MavLinkPacketField('temperature', 40, false, 1, 'uint8_t[]', 4),
];
/**
...
OsdParamConfig.FIELDS = [
    new mavlink_1.MavLinkPacketField('requestId', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('minValue', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('maxValue', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('increment', 12, false, 4, 'float'),
    ...
    new mavlink_1.MavLinkPacketField('osdScreen', 18, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('osdIndex', 19, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('paramId', 20, false, 1, 'char[]', 16),
    new mavlink_1.MavLinkPacketField('configType', 36, false, 1, 'uint8_t'),
];
/**
...
OsdParamShowConfig.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('targetSystem', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 5, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('osdScreen', 6, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('osdIndex', 7, false, 1, 'uint8_t'),
];
/**
...
OsdParamShowConfigReply.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('maxValue', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('increment', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('result', 16, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('paramId', 17, false, 1, 'char[]', 16),
    new mavlink_1.MavLinkPacketField('configType', 33, false, 1, 'uint8_t'),
];
/**
...
ObstacleDistance3d.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('minDistance', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('maxDistance', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('obstacleId', 24, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('sensorType', 26, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('frame', 27, false, 1, 'uint8_t'),
];
/**
 * Water depth
 */
...
WaterDepth.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('lng', 8, false, 4, 'int32_t'),
    ...
    new mavlink_1.MavLinkPacketField('distance', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('temperature', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('id', 36, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('healthy', 37, false, 1, 'uint8_t'),
];
/**
...
McuStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('MCUTemperature', 0, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('MCUVoltage', 2, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('MCUVoltageMin', 4, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('MCUVoltageMax', 6, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('id', 8, false, 1, 'uint8_t'),
];
exports.REGISTRY = {
    150: SensorOffsets,
    151: SetMagOffsets,
