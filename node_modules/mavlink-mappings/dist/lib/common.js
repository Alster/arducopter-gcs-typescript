...
ManualControl.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('buttons2', 11, true, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('enabledExtensions', 13, true, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('s', 14, true, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('t', 16, true, 2, 'int16_t'),
];
/**
...
EscInfo.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('temperature', 34, false, 2, 'int16_t[]', 4),
    new mavlink_1.MavLinkPacketField('index', 42, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('count', 43, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('connectionType', 44, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('info', 45, false, 1, 'uint8_t'),
];
/**
...
OpenDroneIdAuthentication.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('lastPageIndex', 28, false, 1, 'uint8_t'),
...
OpenDroneIdSystem.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('operatorAltitudeGeo', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('areaCount', 20, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('areaRadius', 22, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 24, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 25, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('idOrMac', 26, false, 1, 'uint8_t[]', 20),
    new mavlink_1.MavLinkPacketField('operatorLocationType', 46, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('classificationType', 47, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('categoryEu', 48, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('classEu', 49, false, 1, 'uint8_t'),
];
/**
...
OpenDroneIdMessagePack.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('targetComponent', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('idOrMac', 2, false, 1, 'uint8_t[]', 20),
    new mavlink_1.MavLinkPacketField('singleMessageSize', 22, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('msgPackSize', 23, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('messages', 24, false, 1, 'uint8_t[]', 225),
];
/**
...
HygrometerSensor.FIELDS = [
    new mavlink_1.MavLinkPacketField('temperature', 0, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('humidity', 2, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('id', 4, false, 1, 'uint8_t'),
];
exports.REGISTRY = {
    1: SysStatus,
    2: SystemTime,
