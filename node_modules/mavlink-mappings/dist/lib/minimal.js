...
Heartbeat.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('type', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('autopilot', 5, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('baseMode', 6, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('systemStatus', 7, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('mavlinkVersion', 8, false, 1, 'uint8_t_mavlink_version'),
];
/**
...
ProtocolVersion.FIELDS = [
    new mavlink_1.MavLinkPacketField('version', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('minVersion', 2, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('maxVersion', 4, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('specVersionHash', 6, false, 1, 'uint8_t[]', 8),
    new mavlink_1.MavLinkPacketField('libraryVersionHash', 14, false, 1, 'uint8_t[]', 8),
];
exports.REGISTRY = {
    0: Heartbeat,
    300: ProtocolVersion,
