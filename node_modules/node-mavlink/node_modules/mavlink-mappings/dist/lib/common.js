...
(function (ComponentCapFlags) {
    ComponentCapFlags[ComponentCapFlags["PARAM"] = 1] = "PARAM";
    ComponentCapFlags[ComponentCapFlags["PARAM_EXT"] = 2] = "PARAM_EXT";
...
SysStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('onboardControlSensorsPresent', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('onboardControlSensorsEnabled', 4, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('onboardControlSensorsHealth', 8, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('load', 12, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('voltageBattery', 14, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('currentBattery', 16, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('dropRateComm', 18, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('errorsComm', 20, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('errorsCount1', 22, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('errorsCount2', 24, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('errorsCount3', 26, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('errorsCount4', 28, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('batteryRemaining', 30, false, 1, 'int8_t'),
];
/**
...
SystemTime.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUnixUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('timeBootMs', 8, false, 4, 'uint32_t'),
];
/**
...
Ping.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('seq', 8, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 12, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 13, false, 1, 'uint8_t'),
];
/**
...
ChangeOperatorControl.FIELDS = [
    new mavlink_1.MavLinkPacketField('targetSystem', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('controlRequest', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('version', 2, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('passkey', 3, false, 1, 'char[]', 25),
];
/**
...
ChangeOperatorControlAck.FIELDS = [
    new mavlink_1.MavLinkPacketField('gcsSystemId', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('controlRequest', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('ack', 2, false, 1, 'uint8_t'),
];
/**
...
AuthKey.FIELDS = [
    new mavlink_1.MavLinkPacketField('key', 0, false, 1, 'char[]', 32),
];
/**
...
LinkNodeStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('timestamp', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('txRate', 8, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('rxRate', 12, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('messagesSent', 16, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('messagesReceived', 20, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('messagesLost', 24, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('rxParseErr', 28, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('txOverflows', 30, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('rxOverflows', 32, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('txBuf', 34, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('rxBuf', 35, false, 1, 'uint8_t'),
];
/**
...
SetMode.FIELDS = [
    new mavlink_1.MavLinkPacketField('customMode', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('baseMode', 5, false, 1, 'uint8_t'),
];
/**
...
ParamAckTransaction.FIELDS = [
    new mavlink_1.MavLinkPacketField('paramValue', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('targetSystem', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 5, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('paramId', 6, false, 1, 'char[]', 16),
    new mavlink_1.MavLinkPacketField('paramType', 22, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('paramResult', 23, false, 1, 'uint8_t'),
];
/**
...
ParamRequestRead.FIELDS = [
    new mavlink_1.MavLinkPacketField('paramIndex', 0, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 2, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 3, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('paramId', 4, false, 1, 'char[]', 16),
];
/**
...
ParamRequestList.FIELDS = [
    new mavlink_1.MavLinkPacketField('targetSystem', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 1, false, 1, 'uint8_t'),
];
/**
...
ParamValue.FIELDS = [
    new mavlink_1.MavLinkPacketField('paramValue', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('paramCount', 4, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('paramIndex', 6, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('paramId', 8, false, 1, 'char[]', 16),
    new mavlink_1.MavLinkPacketField('paramType', 24, false, 1, 'uint8_t'),
];
/**
...
GpsRawInt.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('lat', 8, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('lon', 12, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('alt', 16, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('eph', 20, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('epv', 22, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('vel', 24, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('cog', 26, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('fixType', 28, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('satellitesVisible', 29, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('altEllipsoid', 30, true, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('hAcc', 34, true, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('vAcc', 38, true, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('velAcc', 42, true, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('hdgAcc', 46, true, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('yaw', 50, true, 2, 'uint16_t'),
];
/**
...
GpsStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('satellitesVisible', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('satellitePrn', 1, false, 1, 'uint8_t[]', 20),
    new mavlink_1.MavLinkPacketField('satelliteUsed', 21, false, 1, 'uint8_t[]', 20),
    new mavlink_1.MavLinkPacketField('satelliteElevation', 41, false, 1, 'uint8_t[]', 20),
    new mavlink_1.MavLinkPacketField('satelliteAzimuth', 61, false, 1, 'uint8_t[]', 20),
    new mavlink_1.MavLinkPacketField('satelliteSnr', 81, false, 1, 'uint8_t[]', 20),
];
/**
...
ScaledImu.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('xacc', 4, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('yacc', 6, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('zacc', 8, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('xgyro', 10, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('ygyro', 12, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('zgyro', 14, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('xmag', 16, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('ymag', 18, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('zmag', 20, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('temperature', 22, true, 2, 'int16_t'),
];
/**
...
RawImu.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('xacc', 8, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('yacc', 10, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('zacc', 12, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('xgyro', 14, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('ygyro', 16, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('zgyro', 18, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('xmag', 20, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('ymag', 22, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('zmag', 24, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('id', 26, true, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('temperature', 27, true, 2, 'int16_t'),
];
/**
...
RawPressure.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('pressAbs', 8, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('pressDiff1', 10, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('pressDiff2', 12, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('temperature', 14, false, 2, 'int16_t'),
];
/**
...
ScaledPressure.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('pressAbs', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pressDiff', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('temperature', 12, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('temperaturePressDiff', 14, true, 2, 'int16_t'),
];
/**
...
Attitude.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('roll', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pitch', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yaw', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('rollspeed', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pitchspeed', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yawspeed', 24, false, 4, 'float'),
];
/**
...
AttitudeQuaternion.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('q1', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('q2', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('q3', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('q4', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('rollspeed', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pitchspeed', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yawspeed', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('reprOffsetQ', 32, true, 4, 'float[]', 4),
];
/**
...
LocalPositionNed.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('x', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('y', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('z', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vx', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vy', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vz', 24, false, 4, 'float'),
];
/**
...
GlobalPositionInt.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('lat', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('lon', 8, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('alt', 12, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('relativeAlt', 16, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('vx', 20, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('vy', 22, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('vz', 24, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('hdg', 26, false, 2, 'uint16_t'),
];
/**
...
RcChannelsScaled.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('chan1Scaled', 4, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('chan2Scaled', 6, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('chan3Scaled', 8, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('chan4Scaled', 10, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('chan5Scaled', 12, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('chan6Scaled', 14, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('chan7Scaled', 16, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('chan8Scaled', 18, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('port', 20, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('rssi', 21, false, 1, 'uint8_t'),
];
/**
...
RcChannelsRaw.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('chan1Raw', 4, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan2Raw', 6, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan3Raw', 8, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan4Raw', 10, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan5Raw', 12, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan6Raw', 14, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan7Raw', 16, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan8Raw', 18, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('port', 20, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('rssi', 21, false, 1, 'uint8_t'),
];
/**
...
ServoOutputRaw.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('servo1Raw', 4, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('servo2Raw', 6, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('servo3Raw', 8, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('servo4Raw', 10, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('servo5Raw', 12, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('servo6Raw', 14, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('servo7Raw', 16, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('servo8Raw', 18, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('port', 20, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('servo9Raw', 21, true, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('servo10Raw', 23, true, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('servo11Raw', 25, true, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('servo12Raw', 27, true, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('servo13Raw', 29, true, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('servo14Raw', 31, true, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('servo15Raw', 33, true, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('servo16Raw', 35, true, 2, 'uint16_t'),
];
/**
...
MissionRequestPartialList.FIELDS = [
    new mavlink_1.MavLinkPacketField('startIndex', 0, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('endIndex', 2, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 5, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('missionType', 6, true, 1, 'uint8_t'),
];
/**
...
MissionItem.FIELDS = [
    new mavlink_1.MavLinkPacketField('param1', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('param2', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('param3', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('param4', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('x', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('y', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('z', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('seq', 28, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('command', 30, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 32, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 33, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('frame', 34, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('current', 35, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('autocontinue', 36, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('missionType', 37, true, 1, 'uint8_t'),
];
/**
...
MissionRequest.FIELDS = [
    new mavlink_1.MavLinkPacketField('seq', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 2, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 3, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('missionType', 4, true, 1, 'uint8_t'),
];
/**
 * Set the mission item with sequence number seq as current item. This means that the MAV will continue
 * to this mission item on the shortest path (not following the mission items in-between).
...
MissionRequestList.FIELDS = [
    new mavlink_1.MavLinkPacketField('targetSystem', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('missionType', 2, true, 1, 'uint8_t'),
];
/**
...
MissionCount.FIELDS = [
    new mavlink_1.MavLinkPacketField('count', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 2, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 3, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('missionType', 4, true, 1, 'uint8_t'),
];
...
MissionAck.FIELDS = [
    new mavlink_1.MavLinkPacketField('targetSystem', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('type', 2, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('missionType', 3, true, 1, 'uint8_t'),
];
/**
...
SetGpsGlobalOrigin.FIELDS = [
    new mavlink_1.MavLinkPacketField('latitude', 0, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('longitude', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('altitude', 8, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 12, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('timeUsec', 13, true, 8, 'uint64_t'),
];
/**
...
GpsGlobalOrigin.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('longitude', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('altitude', 8, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('timeUsec', 12, true, 8, 'uint64_t'),
];
/**
...
ParamMapRc.FIELDS = [
    new mavlink_1.MavLinkPacketField('paramValue0', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('scale', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('paramValueMin', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('paramValueMax', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('paramIndex', 16, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 18, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 19, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('paramId', 20, false, 1, 'char[]', 16),
    new mavlink_1.MavLinkPacketField('parameterRcChannelIndex', 36, false, 1, 'uint8_t'),
];
/**
 * Request the information of the mission item with the sequence number seq. The response of the system
...
MissionChanged.FIELDS = [
    new mavlink_1.MavLinkPacketField('startIndex', 0, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('endIndex', 2, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('originSysid', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('originCompid', 5, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('missionType', 6, false, 1, 'uint8_t'),
];
/**
...
SafetySetAllowedArea.FIELDS = [
    new mavlink_1.MavLinkPacketField('p1x', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('p1y', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('p1z', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('p2x', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('p2y', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('p2z', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('targetSystem', 24, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 25, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('frame', 26, false, 1, 'uint8_t'),
];
/**
...
SafetyAllowedArea.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('p2y', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('p2z', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('frame', 24, false, 1, 'uint8_t'),
];
/**
 * The attitude in the aeronautical frame (right-handed, Z-down, X-front, Y-right), expressed as
 * quaternion. Quaternion order is w, x, y, z and a zero rotation would be expressed as (1 0 0 0).
...
AttitudeQuaternionCov.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('q', 8, false, 4, 'float[]', 4),
    new mavlink_1.MavLinkPacketField('rollspeed', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pitchspeed', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yawspeed', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('covariance', 36, false, 4, 'float[]', 9),
];
/**
...
NavControllerOutput.FIELDS = [
    new mavlink_1.MavLinkPacketField('navRoll', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('navPitch', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('altError', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('aspdError', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('xtrackError', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('navBearing', 20, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('targetBearing', 22, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('wpDist', 24, false, 2, 'uint16_t'),
];
/**
 * The filtered global position (e.g. fused GPS and accelerometers). The position is in GPS-frame
 * (right-handed, Z-up). It is designed as scaled integer message since the resolution of float is not
...
GlobalPositionIntCov.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('lon', 12, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('alt', 16, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('relativeAlt', 20, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('vx', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vy', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vz', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('covariance', 36, false, 4, 'float[]', 36),
    new mavlink_1.MavLinkPacketField('estimatorType', 180, false, 1, 'uint8_t'),
];
/**
 * The filtered local position (e.g. fused computer vision and accelerometers). Coordinate frame is
 * right-handed, Z-axis down (aeronautical frame, NED / north-east-down convention)
...
LocalPositionNedCov.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('x', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('y', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('z', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vx', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vy', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vz', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('ax', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('ay', 36, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('az', 40, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('covariance', 44, false, 4, 'float[]', 45),
    new mavlink_1.MavLinkPacketField('estimatorType', 224, false, 1, 'uint8_t'),
];
/**
...
RcChannels.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('chan7Raw', 16, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan8Raw', 18, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan9Raw', 20, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan10Raw', 22, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan11Raw', 24, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan12Raw', 26, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan13Raw', 28, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan14Raw', 30, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan15Raw', 32, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan16Raw', 34, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan17Raw', 36, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan18Raw', 38, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chancount', 40, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('rssi', 41, false, 1, 'uint8_t'),
];
/**
...
RequestDataStream.FIELDS = [
    new mavlink_1.MavLinkPacketField('reqMessageRate', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 2, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 3, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('reqStreamId', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('startStop', 5, false, 1, 'uint8_t'),
];
/**
...
DataStream.FIELDS = [
    new mavlink_1.MavLinkPacketField('messageRate', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('streamId', 2, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('onOff', 3, false, 1, 'uint8_t'),
];
/**
...
ManualControl.FIELDS = [
    new mavlink_1.MavLinkPacketField('x', 0, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('y', 2, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('z', 4, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('r', 6, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('buttons', 8, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('target', 10, false, 1, 'uint8_t'),
];
/**
...
RcChannelsOverride.FIELDS = [
    new mavlink_1.MavLinkPacketField('chan1Raw', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan2Raw', 2, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan3Raw', 4, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan4Raw', 6, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan5Raw', 8, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan6Raw', 10, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan7Raw', 12, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan8Raw', 14, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 16, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 17, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('chan9Raw', 18, true, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan10Raw', 20, true, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan11Raw', 22, true, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan12Raw', 24, true, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan13Raw', 26, true, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan14Raw', 28, true, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan15Raw', 30, true, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan16Raw', 32, true, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan17Raw', 34, true, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan18Raw', 36, true, 2, 'uint16_t'),
];
/**
 * Message encoding a mission item. This message is emitted to announce the presence of a mission item
 * and to set a mission item on the system. The mission item can be either in x, y, z meters (type:
...
MissionItemInt.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('param3', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('param4', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('x', 16, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('y', 20, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('z', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('seq', 28, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('command', 30, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 32, false, 1, 'uint8_t'),
...
VfrHud.FIELDS = [
    new mavlink_1.MavLinkPacketField('airspeed', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('groundspeed', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('alt', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('climb', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('heading', 16, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('throttle', 18, false, 2, 'uint16_t'),
];
/**
...
CommandInt.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('y', 20, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('z', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('command', 28, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 30, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 31, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('frame', 32, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('current', 33, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('autocontinue', 34, false, 1, 'uint8_t'),
];
/**
...
CommandLong.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('param3', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('param4', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('param5', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('param6', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('param7', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('command', 28, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 30, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 31, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('confirmation', 32, false, 1, 'uint8_t'),
];
/**
...
CommandAck.FIELDS = [
    new mavlink_1.MavLinkPacketField('command', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('result', 2, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('progress', 3, true, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('resultParam2', 4, true, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 8, true, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 9, true, 1, 'uint8_t'),
];
/**
...
ManualSetpoint.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('pitch', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yaw', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('thrust', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('modeSwitch', 20, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('manualOverrideSwitch', 21, false, 1, 'uint8_t'),
];
/**
...
SetAttitudeTarget.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('q', 4, false, 4, 'float[]', 4),
    new mavlink_1.MavLinkPacketField('bodyRollRate', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('bodyPitchRate', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('bodyYawRate', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('thrust', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('targetSystem', 36, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 37, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('typeMask', 38, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('thrustBody', 39, true, 4, 'float[]', 3),
];
/**
...
AttitudeTarget.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('bodyYawRate', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('thrust', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('typeMask', 36, false, 1, 'uint8_t'),
];
/**
...
SetPositionTargetLocalNed.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('vy', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vz', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('afx', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('afy', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('afz', 36, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yaw', 40, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yawRate', 44, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('typeMask', 48, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 50, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 51, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('coordinateFrame', 52, false, 1, 'uint8_t'),
];
/**
...
PositionTargetLocalNed.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('yawRate', 44, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('typeMask', 48, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('coordinateFrame', 50, false, 1, 'uint8_t'),
];
/**
...
SetPositionTargetGlobalInt.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('latInt', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('lonInt', 8, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('alt', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vx', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vy', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vz', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('afx', 28, false, 4, 'float'),
...
LocalPositionNedSystemGlobalOffset.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('y', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('z', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('roll', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pitch', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yaw', 24, false, 4, 'float'),
];
/**
...
HilState.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('roll', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pitch', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yaw', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('rollspeed', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pitchspeed', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yawspeed', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('lat', 32, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('lon', 36, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('alt', 40, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('vx', 44, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('vy', 46, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('vz', 48, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('xacc', 50, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('yacc', 52, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('zacc', 54, false, 2, 'int16_t'),
];
/**
...
HilControls.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('rollAilerons', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pitchElevator', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yawRudder', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('throttle', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('aux1', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('aux2', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('aux3', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('aux4', 36, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('mode', 40, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('navMode', 41, false, 1, 'uint8_t'),
];
/**
...
HilRcInputsRaw.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('chan1Raw', 8, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan2Raw', 10, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan3Raw', 12, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan4Raw', 14, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan5Raw', 16, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan6Raw', 18, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan7Raw', 20, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan8Raw', 22, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan9Raw', 24, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan10Raw', 26, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan11Raw', 28, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chan12Raw', 30, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('rssi', 32, false, 1, 'uint8_t'),
];
/**
...
HilActuatorControls.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('flags', 8, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('controls', 16, false, 4, 'float[]', 16),
    new mavlink_1.MavLinkPacketField('mode', 80, false, 1, 'uint8_t'),
];
/**
...
OpticalFlow.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('flowCompMX', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('flowCompMY', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('groundDistance', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('flowX', 20, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('flowY', 22, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('sensorId', 24, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('quality', 25, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('flowRateX', 26, true, 4, 'float'),
    new mavlink_1.MavLinkPacketField('flowRateY', 30, true, 4, 'float'),
];
/**
...
GlobalVisionPositionEstimate.FIELDS = [
    new mavlink_1.MavLinkPacketField('usec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('x', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('y', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('z', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('roll', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pitch', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yaw', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('covariance', 32, true, 4, 'float[]', 21),
    new mavlink_1.MavLinkPacketField('resetCounter', 116, true, 1, 'uint8_t'),
];
/**
...
VisionSpeedEstimate.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('y', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('z', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('covariance', 20, true, 4, 'float[]', 9),
    new mavlink_1.MavLinkPacketField('resetCounter', 56, true, 1, 'uint8_t'),
];
/**
...
HighresImu.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('xacc', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yacc', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('zacc', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('xgyro', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('ygyro', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('zgyro', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('xmag', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('ymag', 36, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('zmag', 40, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('absPressure', 44, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('diffPressure', 48, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pressureAlt', 52, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('temperature', 56, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('fieldsUpdated', 60, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('id', 62, true, 1, 'uint8_t'),
];
/**
...
OpticalFlowRad.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('integrationTimeUs', 8, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('integratedX', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('integratedY', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('integratedXgyro', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('integratedYgyro', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('integratedZgyro', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('timeDeltaDistanceUs', 32, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('distance', 36, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('temperature', 40, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('sensorId', 42, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('quality', 43, false, 1, 'uint8_t'),
];
/**
 * The IMU readings in SI units in NED body frame
 */
...
HilSensor.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('pressureAlt', 52, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('temperature', 56, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('fieldsUpdated', 60, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('id', 64, true, 1, 'uint8_t'),
];
/**
...
SimState.FIELDS = [
    new mavlink_1.MavLinkPacketField('q1', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('q2', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('q3', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('q4', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('roll', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pitch', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yaw', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('xacc', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yacc', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('zacc', 36, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('xgyro', 40, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('ygyro', 44, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('zgyro', 48, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('lat', 52, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('lon', 56, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('alt', 60, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('stdDevHorz', 64, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('stdDevVert', 68, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vn', 72, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('ve', 76, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vd', 80, false, 4, 'float'),
];
/**
...
RadioStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('rxerrors', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('fixed', 2, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('rssi', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('remrssi', 5, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('txbuf', 6, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('noise', 7, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('remnoise', 8, false, 1, 'uint8_t'),
];
/**
...
FileTransferProtocol.FIELDS = [
    new mavlink_1.MavLinkPacketField('targetNetwork', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 2, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('payload', 3, false, 1, 'uint8_t[]', 251),
];
/**
...
TimeSync.FIELDS = [
    new mavlink_1.MavLinkPacketField('tc1', 0, false, 8, 'int64_t'),
    new mavlink_1.MavLinkPacketField('ts1', 8, false, 8, 'int64_t'),
];
/**
...
HilGps.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('epv', 22, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('vel', 24, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('vn', 26, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('ve', 28, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('vd', 30, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('cog', 32, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('fixType', 34, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('satellitesVisible', 35, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('id', 36, true, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('yaw', 37, true, 2, 'uint16_t'),
];
/**
...
HilStateQuaternion.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('attitudeQuaternion', 8, false, 4, 'float[]', 4),
    new mavlink_1.MavLinkPacketField('rollspeed', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pitchspeed', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yawspeed', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('lat', 36, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('lon', 40, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('alt', 44, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('vx', 48, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('vy', 50, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('vz', 52, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('indAirspeed', 54, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('trueAirspeed', 56, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('xacc', 58, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('yacc', 60, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('zacc', 62, false, 2, 'int16_t'),
];
/**
...
LogRequestList.FIELDS = [
    new mavlink_1.MavLinkPacketField('start', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('end', 2, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 5, false, 1, 'uint8_t'),
];
/**
...
LogEntry.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUtc', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('size', 4, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('id', 8, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('numLogs', 10, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('lastLogNum', 12, false, 2, 'uint16_t'),
];
/**
...
LogRequestData.FIELDS = [
    new mavlink_1.MavLinkPacketField('ofs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('count', 4, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('id', 8, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 10, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 11, false, 1, 'uint8_t'),
];
/**
...
LogData.FIELDS = [
    new mavlink_1.MavLinkPacketField('ofs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('id', 4, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('count', 6, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('data', 7, false, 1, 'uint8_t[]', 90),
];
/**
 * Erase all logs
 */
...
GpsInjectData.FIELDS = [
    new mavlink_1.MavLinkPacketField('targetSystem', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('len', 2, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('data', 3, false, 1, 'uint8_t[]', 110),
];
/**
 * Second GPS data.
 */
...
Gps2Raw.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('lon', 12, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('alt', 16, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('dgpsAge', 20, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('eph', 24, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('epv', 26, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('vel', 28, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('cog', 30, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('fixType', 32, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('satellitesVisible', 33, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('dgpsNumch', 34, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('yaw', 35, true, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('altEllipsoid', 37, true, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('hAcc', 41, true, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('vAcc', 45, true, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('velAcc', 49, true, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('hdgAcc', 53, true, 4, 'uint32_t'),
];
/**
 * Power supply status
 */
...
PowerStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('Vcc', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('Vservo', 2, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('flags', 4, false, 2, 'uint16_t'),
];
/**
...
SerialControl.FIELDS = [
    new mavlink_1.MavLinkPacketField('baudrate', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('timeout', 4, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('device', 6, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('flags', 7, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('count', 8, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('data', 9, false, 1, 'uint8_t[]', 70),
];
/**
...
GpsRtk.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeLastBaselineMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('tow', 4, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('baselineAMm', 8, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('baselineBMm', 12, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('baselineCMm', 16, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('accuracy', 20, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('iarNumHypotheses', 24, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('wn', 28, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('rtkReceiverId', 30, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('rtkHealth', 31, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('rtkRate', 32, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('nsats', 33, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('baselineCoordsType', 34, false, 1, 'uint8_t'),
];
/**
 * RTK GPS data. Gives information on the relative baseline calculation the GPS is reporting
 */
...
DataTransmissionHandshake.FIELDS = [
    new mavlink_1.MavLinkPacketField('size', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('width', 4, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('height', 6, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('packets', 8, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('type', 10, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('payload', 11, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('jpgQuality', 12, false, 1, 'uint8_t'),
];
/**
...
EncapsulatedData.FIELDS = [
    new mavlink_1.MavLinkPacketField('seqnr', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('data', 2, false, 1, 'uint8_t[]', 253),
];
/**
...
DistanceSensor.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('minDistance', 4, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('maxDistance', 6, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('currentDistance', 8, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('type', 10, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('id', 11, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('orientation', 12, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('covariance', 13, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('horizontalFov', 14, true, 4, 'float'),
    new mavlink_1.MavLinkPacketField('verticalFov', 18, true, 4, 'float'),
    new mavlink_1.MavLinkPacketField('quaternion', 22, true, 4, 'float[]', 4),
    new mavlink_1.MavLinkPacketField('signalQuality', 38, true, 1, 'uint8_t'),
];
/**
...
TerrainRequest.FIELDS = [
    new mavlink_1.MavLinkPacketField('mask', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('lat', 8, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('lon', 12, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('gridSpacing', 16, false, 2, 'uint16_t'),
];
/**
...
TerrainData.FIELDS = [
    new mavlink_1.MavLinkPacketField('lat', 0, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('lon', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('gridSpacing', 8, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('data', 10, false, 2, 'int16_t[]', 16),
    new mavlink_1.MavLinkPacketField('gridbit', 42, false, 1, 'uint8_t'),
];
/**
...
TerrainReport.FIELDS = [
    new mavlink_1.MavLinkPacketField('lat', 0, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('lon', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('terrainHeight', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('currentHeight', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('spacing', 16, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('pending', 18, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('loaded', 20, false, 2, 'uint16_t'),
];
/**
...
MotionCaptureAttPos.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('q', 8, false, 4, 'float[]', 4),
    new mavlink_1.MavLinkPacketField('x', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('y', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('z', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('covariance', 36, true, 4, 'float[]', 21),
];
/**
...
SetActuatorControlTarget.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('controls', 8, false, 4, 'float[]', 8),
    new mavlink_1.MavLinkPacketField('groupMlx', 40, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 41, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 42, false, 1, 'uint8_t'),
];
/**
 * Set the vehicle attitude and body angular rates.
 */
...
Altitude.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('altitudeMonotonic', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('altitudeAmsl', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('altitudeLocal', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('altitudeRelative', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('altitudeTerrain', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('bottomClearance', 28, false, 4, 'float'),
];
/**
...
ResourceRequest.FIELDS = [
    new mavlink_1.MavLinkPacketField('requestId', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('uriType', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('uri', 2, false, 1, 'uint8_t[]', 120),
    new mavlink_1.MavLinkPacketField('transferType', 122, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('storage', 123, false, 1, 'uint8_t[]', 120),
];
/**
...
FollowTarget.FIELDS = [
    new mavlink_1.MavLinkPacketField('timestamp', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('customState', 8, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('lat', 16, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('lon', 20, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('alt', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vel', 28, false, 4, 'float[]', 3),
    new mavlink_1.MavLinkPacketField('acc', 40, false, 4, 'float[]', 3),
    new mavlink_1.MavLinkPacketField('attitudeQ', 52, false, 4, 'float[]', 4),
    new mavlink_1.MavLinkPacketField('rates', 68, false, 4, 'float[]', 3),
    new mavlink_1.MavLinkPacketField('positionCov', 80, false, 4, 'float[]', 3),
    new mavlink_1.MavLinkPacketField('estCapabilities', 92, false, 1, 'uint8_t'),
];
/**
...
ControlSystemState.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('yAcc', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('zAcc', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('xVel', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yVel', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('zVel', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('xPos', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yPos', 36, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('zPos', 40, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('airspeed', 44, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('velVariance', 48, false, 4, 'float[]', 3),
    new mavlink_1.MavLinkPacketField('posVariance', 60, false, 4, 'float[]', 3),
    new mavlink_1.MavLinkPacketField('q', 72, false, 4, 'float[]', 4),
    new mavlink_1.MavLinkPacketField('rollRate', 88, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pitchRate', 92, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yawRate', 96, false, 4, 'float'),
];
/**
...
BatteryStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('currentConsumed', 0, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('energyConsumed', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('temperature', 8, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('voltages', 10, false, 2, 'uint16_t[]', 10),
    new mavlink_1.MavLinkPacketField('currentBattery', 30, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('id', 32, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('batteryFunction', 33, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('type', 34, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('batteryRemaining', 35, false, 1, 'int8_t'),
    new mavlink_1.MavLinkPacketField('timeRemaining', 36, true, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('chargeState', 40, true, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('voltagesExt', 41, true, 2, 'uint16_t[]', 4),
    new mavlink_1.MavLinkPacketField('mode', 49, true, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('faultBitmask', 50, true, 4, 'uint32_t'),
];
/**
...
AutopilotVersion.FIELDS = [
    new mavlink_1.MavLinkPacketField('capabilities', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('uid', 8, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('flightSwVersion', 16, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('middlewareSwVersion', 20, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('osSwVersion', 24, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('boardVersion', 28, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('vendorId', 32, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('productId', 34, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('flightCustomVersion', 36, false, 1, 'uint8_t[]', 8),
    new mavlink_1.MavLinkPacketField('middlewareCustomVersion', 44, false, 1, 'uint8_t[]', 8),
    new mavlink_1.MavLinkPacketField('osCustomVersion', 52, false, 1, 'uint8_t[]', 8),
    new mavlink_1.MavLinkPacketField('uid2', 60, true, 1, 'uint8_t[]', 18),
];
/**
...
LandingTarget.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('angleX', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('angleY', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('distance', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('sizeX', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('sizeY', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('targetNum', 28, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('frame', 29, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('x', 30, true, 4, 'float'),
    new mavlink_1.MavLinkPacketField('y', 34, true, 4, 'float'),
    new mavlink_1.MavLinkPacketField('z', 38, true, 4, 'float'),
    new mavlink_1.MavLinkPacketField('q', 42, true, 4, 'float[]', 4),
    new mavlink_1.MavLinkPacketField('type', 58, true, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('positionValid', 59, true, 1, 'uint8_t'),
];
/**
...
FenceStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('breachTime', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('breachCount', 4, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('breachStatus', 6, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('breachType', 7, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('breachMitigation', 8, true, 1, 'uint8_t'),
];
/**
...
MagCalReport.FIELDS = [
    new mavlink_1.MavLinkPacketField('fitness', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('ofsX', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('ofsY', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('ofsZ', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('diagX', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('diagY', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('diagZ', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('offdiagX', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('offdiagY', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('offdiagZ', 36, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('compassId', 40, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('calMask', 41, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('calStatus', 42, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('autosaved', 43, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('orientationConfidence', 44, true, 4, 'float'),
    new mavlink_1.MavLinkPacketField('oldOrientation', 48, true, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('newOrientation', 49, true, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('scaleFactor', 50, true, 4, 'float'),
];
/**
 * EFI status output
 */
...
EfiStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('ecuIndex', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('rpm', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('fuelConsumed', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('fuelFlow', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('engineLoad', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('throttlePosition', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('sparkDwellTime', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('barometricPressure', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('intakeManifoldPressure', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('intakeManifoldTemperature', 36, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('cylinderHeadTemperature', 40, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('ignitionTiming', 44, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('injectionTime', 48, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('exhaustGasTemperature', 52, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('throttleOut', 56, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('ptCompensation', 60, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('health', 64, false, 1, 'uint8_t'),
];
/**
...
EstimatorStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('velRatio', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('posHorizRatio', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('posVertRatio', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('magRatio', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('haglRatio', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('tasRatio', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('posHorizAccuracy', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('posVertAccuracy', 36, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('flags', 40, false, 2, 'uint16_t'),
];
/**
...
WindCov.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('windX', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('windY', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('windZ', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('varHoriz', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('varVert', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('windAlt', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('horizAccuracy', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vertAccuracy', 36, false, 4, 'float'),
];
/**
...
GpsInput.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('timeWeekMs', 8, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('lat', 12, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('lon', 16, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('alt', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('hdop', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vdop', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vn', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('ve', 36, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vd', 40, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('speedAccuracy', 44, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('horizAccuracy', 48, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vertAccuracy', 52, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('ignoreFlags', 56, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('timeWeek', 58, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('gpsId', 60, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('fixType', 61, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('satellitesVisible', 62, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('yaw', 63, true, 2, 'uint16_t'),
];
/**
...
GpsRtcmData.FIELDS = [
    new mavlink_1.MavLinkPacketField('flags', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('len', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('data', 2, false, 1, 'uint8_t[]', 180),
];
/**
...
HighLatency.FIELDS = [
    new mavlink_1.MavLinkPacketField('customMode', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('latitude', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('longitude', 8, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('roll', 12, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('pitch', 14, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('heading', 16, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('headingSp', 18, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('altitudeAmsl', 20, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('altitudeSp', 22, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('wpDistance', 24, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('baseMode', 26, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('landedState', 27, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('throttle', 28, false, 1, 'int8_t'),
    new mavlink_1.MavLinkPacketField('airspeed', 29, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('airspeedSp', 30, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('groundspeed', 31, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('climbRate', 32, false, 1, 'int8_t'),
    new mavlink_1.MavLinkPacketField('gpsNsat', 33, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('gpsFixType', 34, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('batteryRemaining', 35, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('temperature', 36, false, 1, 'int8_t'),
    new mavlink_1.MavLinkPacketField('temperatureAir', 37, false, 1, 'int8_t'),
    new mavlink_1.MavLinkPacketField('failsafe', 38, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('wpNum', 39, false, 1, 'uint8_t'),
];
/**
...
HighLatency2.FIELDS = [
    new mavlink_1.MavLinkPacketField('timestamp', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('latitude', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('longitude', 8, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('customMode', 12, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('altitude', 14, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('targetAltitude', 16, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('targetDistance', 18, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('wpNum', 20, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('failureFlags', 22, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('type', 24, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('autopilot', 25, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('heading', 26, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetHeading', 27, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('throttle', 28, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('airspeed', 29, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('airspeedSp', 30, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('groundspeed', 31, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('windspeed', 32, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('windHeading', 33, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('eph', 34, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('epv', 35, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('temperatureAir', 36, false, 1, 'int8_t'),
    new mavlink_1.MavLinkPacketField('climbRate', 37, false, 1, 'int8_t'),
    new mavlink_1.MavLinkPacketField('battery', 38, false, 1, 'int8_t'),
    new mavlink_1.MavLinkPacketField('custom0', 39, false, 1, 'int8_t'),
    new mavlink_1.MavLinkPacketField('custom1', 40, false, 1, 'int8_t'),
    new mavlink_1.MavLinkPacketField('custom2', 41, false, 1, 'int8_t'),
];
/**
...
Vibration.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('vibrationX', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vibrationY', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vibrationZ', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('clipping0', 20, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('clipping1', 24, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('clipping2', 28, false, 4, 'uint32_t'),
];
/**
...
HomePosition.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('longitude', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('altitude', 8, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('x', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('y', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('z', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('q', 24, false, 4, 'float[]', 4),
    new mavlink_1.MavLinkPacketField('approachX', 40, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('approachY', 44, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('approachZ', 48, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('timeUsec', 52, true, 8, 'uint64_t'),
];
/**
...
SetHomePosition.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('approachY', 44, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('approachZ', 48, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('targetSystem', 52, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('timeUsec', 53, true, 8, 'uint64_t'),
];
/**
...
MessageInterval.FIELDS = [
    new mavlink_1.MavLinkPacketField('intervalUs', 0, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('messageId', 4, false, 2, 'uint16_t'),
];
/**
...
ExtendedSysState.FIELDS = [
    new mavlink_1.MavLinkPacketField('vtolState', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('landedState', 1, false, 1, 'uint8_t'),
];
/**
...
AdsbVehicle.FIELDS = [
    new mavlink_1.MavLinkPacketField('ICAOAddress', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('lat', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('lon', 8, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('altitude', 12, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('heading', 16, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('horVelocity', 18, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('verVelocity', 20, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('flags', 22, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('squawk', 24, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('altitudeType', 26, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('callsign', 27, false, 1, 'char[]', 9),
    new mavlink_1.MavLinkPacketField('emitterType', 36, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('tslc', 37, false, 1, 'uint8_t'),
];
/**
...
Collision.FIELDS = [
    new mavlink_1.MavLinkPacketField('id', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('timeToMinimumDelta', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('altitudeMinimumDelta', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('horizontalMinimumDelta', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('src', 16, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('action', 17, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('threatLevel', 18, false, 1, 'uint8_t'),
];
/**
...
V2Extension.FIELDS = [
    new mavlink_1.MavLinkPacketField('messageType', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetNetwork', 2, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 3, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('payload', 5, false, 1, 'uint8_t[]', 249),
];
/**
...
MemoryVect.FIELDS = [
    new mavlink_1.MavLinkPacketField('address', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('ver', 2, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('type', 3, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('value', 4, false, 1, 'int8_t[]', 32),
];
/**
...
DebugVect.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('y', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('z', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('name', 20, false, 1, 'char[]', 10),
];
/**
...
NamedValueFloat.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('value', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('name', 8, false, 1, 'char[]', 10),
];
/**
...
NamedValueInt.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('value', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('name', 8, false, 1, 'char[]', 10),
];
/**
...
StatusText.FIELDS = [
    new mavlink_1.MavLinkPacketField('severity', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('text', 1, false, 1, 'char[]', 50),
    new mavlink_1.MavLinkPacketField('id', 51, true, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chunkSeq', 53, true, 1, 'uint8_t'),
];
/**
...
Debug.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('value', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('ind', 8, false, 1, 'uint8_t'),
];
/**
...
SetupSigning.FIELDS = [
    new mavlink_1.MavLinkPacketField('initialTimestamp', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 8, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 9, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('secretKey', 10, false, 1, 'uint8_t[]', 32),
];
/**
...
ButtonChange.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('lastChangeMs', 4, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('state', 8, false, 1, 'uint8_t'),
];
/**
...
PlayTune.FIELDS = [
    new mavlink_1.MavLinkPacketField('targetSystem', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('tune', 2, false, 1, 'char[]', 30),
    new mavlink_1.MavLinkPacketField('tune2', 32, true, 1, 'char[]', 200),
];
/**
...
CameraInformation.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('firmwareVersion', 4, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('focalLength', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('sensorSizeH', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('sensorSizeV', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('flags', 20, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('resolutionH', 24, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('resolutionV', 26, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('camDefinitionVersion', 28, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('vendorName', 30, false, 1, 'uint8_t[]', 32),
    new mavlink_1.MavLinkPacketField('modelName', 62, false, 1, 'uint8_t[]', 32),
    new mavlink_1.MavLinkPacketField('lensId', 94, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('camDefinitionUri', 95, false, 1, 'char[]', 140),
];
/**
...
CameraSettings.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('modeId', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('zoomLevel', 5, true, 4, 'float'),
    new mavlink_1.MavLinkPacketField('focusLevel', 9, true, 4, 'float'),
];
/**
...
StorageInformation.PAYLOAD_LENGTH = 60;
StorageInformation.MAGIC_NUMBER = 179;
StorageInformation.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('totalCapacity', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('usedCapacity', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('availableCapacity', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('readSpeed', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('writeSpeed', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('storageId', 24, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('storageCount', 25, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('status', 26, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('type', 27, true, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('name', 28, true, 1, 'char[]', 32),
];
/**
...
CameraCaptureStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('imageInterval', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('recordingTimeMs', 8, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('availableCapacity', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('imageStatus', 16, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('videoStatus', 17, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('imageCount', 18, true, 4, 'int32_t'),
];
/**
...
CameraImageCaptured.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUtc', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('timeBootMs', 8, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('lat', 12, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('lon', 16, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('alt', 20, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('relativeAlt', 24, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('q', 28, false, 4, 'float[]', 4),
    new mavlink_1.MavLinkPacketField('imageIndex', 44, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('cameraId', 48, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('captureResult', 49, false, 1, 'int8_t'),
    new mavlink_1.MavLinkPacketField('fileUrl', 50, false, 1, 'char[]', 205),
];
/**
...
FlightInformation.FIELDS = [
    new mavlink_1.MavLinkPacketField('armingTimeUtc', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('takeoffTimeUtc', 8, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('flightUuid', 16, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('timeBootMs', 24, false, 4, 'uint32_t'),
];
/**
...
MountOrientation.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('pitch', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yaw', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yawAbsolute', 16, true, 4, 'float'),
];
/**
...
LoggingData.FIELDS = [
    new mavlink_1.MavLinkPacketField('sequence', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 2, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 3, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('length', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('firstMessageOffset', 5, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('data', 6, false, 1, 'uint8_t[]', 249),
];
/**
...
VideoStreamInformation.FIELDS = [
    new mavlink_1.MavLinkPacketField('framerate', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('bitrate', 4, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('flags', 8, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('resolutionH', 10, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('resolutionV', 12, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('rotation', 14, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('hfov', 16, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('streamId', 18, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('count', 19, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('type', 20, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('name', 21, false, 1, 'char[]', 32),
    new mavlink_1.MavLinkPacketField('uri', 53, false, 1, 'char[]', 160),
];
/**
...
CameraFovStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('latCamera', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('lonCamera', 8, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('altCamera', 12, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('latImage', 16, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('lonImage', 20, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('altImage', 24, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('q', 28, false, 4, 'float[]', 4),
    new mavlink_1.MavLinkPacketField('hfov', 44, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vfov', 48, false, 4, 'float'),
];
/**
...
CameraTrackingImageStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('pointX', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pointY', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('radius', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('recTopX', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('recTopY', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('recBottomX', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('recBottomY', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('trackingStatus', 28, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('trackingMode', 29, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetData', 30, false, 1, 'uint8_t'),
];
/**
 * Camera tracking status, sent while in active tracking. Use MAV_CMD_SET_MESSAGE_INTERVAL to define
 * message interval.
...
CameraTrackingGeoStatus.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('lon', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('alt', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('hAcc', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vAcc', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('velN', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('velE', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('velD', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('velAcc', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('dist', 36, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('hdg', 40, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('hdgAcc', 44, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('trackingStatus', 48, false, 1, 'uint8_t'),
];
/**
...
GimbalManagerInformation.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('capFlags', 4, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('rollMin', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('rollMax', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pitchMin', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pitchMax', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yawMin', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yawMax', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('gimbalDeviceId', 32, false, 1, 'uint8_t'),
];
/**
...
GimbalManagerStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('flags', 4, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('gimbalDeviceId', 8, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('primaryControlSysid', 9, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('primaryControlCompid', 10, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('secondaryControlSysid', 11, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('secondaryControlCompid', 12, false, 1, 'uint8_t'),
];
/**
...
GimbalManagerSetAttitude.FIELDS = [
    new mavlink_1.MavLinkPacketField('flags', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('q', 4, false, 4, 'float[]', 4),
    new mavlink_1.MavLinkPacketField('angularVelocityX', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('angularVelocityY', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('angularVelocityZ', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('targetSystem', 32, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 33, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('gimbalDeviceId', 34, false, 1, 'uint8_t'),
];
/**
...
GimbalDeviceInformation.FIELDS = [
    new mavlink_1.MavLinkPacketField('uid', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('timeBootMs', 8, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('firmwareVersion', 12, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('hardwareVersion', 16, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('rollMin', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('rollMax', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pitchMin', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pitchMax', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yawMin', 36, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yawMax', 40, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('capFlags', 44, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('customCapFlags', 46, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('vendorName', 48, false, 1, 'char[]', 32),
    new mavlink_1.MavLinkPacketField('modelName', 80, false, 1, 'char[]', 32),
    new mavlink_1.MavLinkPacketField('customName', 112, false, 1, 'char[]', 32),
];
/**
...
GimbalDeviceSetAttitude.FIELDS = [
    new mavlink_1.MavLinkPacketField('q', 0, false, 4, 'float[]', 4),
    new mavlink_1.MavLinkPacketField('angularVelocityX', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('angularVelocityY', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('angularVelocityZ', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('flags', 28, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 30, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 31, false, 1, 'uint8_t'),
];
/**
...
GimbalDeviceAttitudeStatus.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('angularVelocityY', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('angularVelocityZ', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('failureFlags', 32, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('flags', 36, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 38, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 39, false, 1, 'uint8_t'),
];
/**
...
AutopilotStateForGimbalDevice.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootUs', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('q', 8, false, 4, 'float[]', 4),
    new mavlink_1.MavLinkPacketField('qEstimatedDelayUs', 24, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('vx', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vy', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vz', 36, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vEstimatedDelayUs', 40, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('feedForwardAngularVelocityZ', 44, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('estimatorStatus', 48, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 50, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 51, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('landedState', 52, false, 1, 'uint8_t'),
];
/**
...
GimbalManagerSetPitchyaw.FIELDS = [
    new mavlink_1.MavLinkPacketField('flags', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('pitch', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yaw', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pitchRate', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yawRate', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('targetSystem', 20, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 21, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('gimbalDeviceId', 22, false, 1, 'uint8_t'),
];
/**
...
EscInfo.PAYLOAD_LENGTH = 42;
EscInfo.MAGIC_NUMBER = 221;
EscInfo.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('errorCount', 8, false, 4, 'uint32_t[]', 4),
    new mavlink_1.MavLinkPacketField('counter', 24, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('failureFlags', 26, false, 2, 'uint16_t[]', 4),
    new mavlink_1.MavLinkPacketField('index', 34, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('count', 35, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('connectionType', 36, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('info', 37, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('temperature', 38, false, 1, 'uint8_t[]', 4),
];
/**
...
EscStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('rpm', 8, false, 4, 'int32_t[]', 4),
    new mavlink_1.MavLinkPacketField('voltage', 24, false, 4, 'float[]', 4),
    new mavlink_1.MavLinkPacketField('current', 40, false, 4, 'float[]', 4),
    new mavlink_1.MavLinkPacketField('index', 56, false, 1, 'uint8_t'),
];
/**
...
WifiConfigAp.FIELDS = [
    new mavlink_1.MavLinkPacketField('ssid', 0, false, 1, 'char[]', 32),
    new mavlink_1.MavLinkPacketField('password', 32, false, 1, 'char[]', 64),
    new mavlink_1.MavLinkPacketField('mode', 96, true, 1, 'int8_t'),
    new mavlink_1.MavLinkPacketField('response', 97, true, 1, 'int8_t'),
];
/**
...
AisVessel.FIELDS = [
    new mavlink_1.MavLinkPacketField('MMSI', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('lat', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('lon', 8, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('COG', 12, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('heading', 14, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('velocity', 16, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('dimensionBow', 18, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('dimensionStern', 20, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('tslc', 22, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('flags', 24, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('turnRate', 26, false, 1, 'int8_t'),
    new mavlink_1.MavLinkPacketField('navigationalStatus', 27, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('type', 28, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('dimensionPort', 29, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('dimensionStarboard', 30, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('callsign', 31, false, 1, 'char[]', 7),
    new mavlink_1.MavLinkPacketField('name', 38, false, 1, 'char[]', 20),
];
/**
...
UavcanNodeStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('uptimeSec', 8, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('vendorSpecificStatusCode', 12, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('health', 14, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('mode', 15, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('subMode', 16, false, 1, 'uint8_t'),
];
/**
...
UavcanNodeInfo.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('uptimeSec', 8, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('swVcsCommit', 12, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('name', 16, false, 1, 'char[]', 80),
    new mavlink_1.MavLinkPacketField('hwVersionMajor', 96, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('hwVersionMinor', 97, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('hwUniqueId', 98, false, 1, 'uint8_t[]', 16),
    new mavlink_1.MavLinkPacketField('swVersionMajor', 114, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('swVersionMinor', 115, false, 1, 'uint8_t'),
];
/**
...
ParamExtValue.FIELDS = [
    new mavlink_1.MavLinkPacketField('paramCount', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('paramIndex', 2, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('paramId', 4, false, 1, 'char[]', 16),
    new mavlink_1.MavLinkPacketField('paramValue', 20, false, 1, 'char[]', 128),
    new mavlink_1.MavLinkPacketField('paramType', 148, false, 1, 'uint8_t'),
];
/**
...
ParamExtSet.FIELDS = [
    new mavlink_1.MavLinkPacketField('targetSystem', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('paramId', 2, false, 1, 'char[]', 16),
    new mavlink_1.MavLinkPacketField('paramValue', 18, false, 1, 'char[]', 128),
    new mavlink_1.MavLinkPacketField('paramType', 146, false, 1, 'uint8_t'),
];
/**
...
ParamExtAck.FIELDS = [
    new mavlink_1.MavLinkPacketField('paramId', 0, false, 1, 'char[]', 16),
    new mavlink_1.MavLinkPacketField('paramValue', 16, false, 1, 'char[]', 128),
    new mavlink_1.MavLinkPacketField('paramType', 144, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('paramResult', 145, false, 1, 'uint8_t'),
];
/**
...
ObstacleDistance.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('distances', 8, false, 2, 'uint16_t[]', 72),
    new mavlink_1.MavLinkPacketField('minDistance', 152, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('maxDistance', 154, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('sensorType', 156, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('increment', 157, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('incrementF', 158, true, 4, 'float'),
    new mavlink_1.MavLinkPacketField('angleOffset', 162, true, 4, 'float'),
    new mavlink_1.MavLinkPacketField('frame', 166, true, 1, 'uint8_t'),
];
/**
...
Odometry.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('y', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('z', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('q', 20, false, 4, 'float[]', 4),
    new mavlink_1.MavLinkPacketField('vx', 36, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vy', 40, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('vz', 44, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('rollspeed', 48, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('pitchspeed', 52, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('yawspeed', 56, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('poseCovariance', 60, false, 4, 'float[]', 21),
    new mavlink_1.MavLinkPacketField('velocityCovariance', 144, false, 4, 'float[]', 21),
    new mavlink_1.MavLinkPacketField('frameId', 228, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('childFrameId', 229, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('resetCounter', 230, true, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('estimatorType', 231, true, 1, 'uint8_t'),
];
/**
...
TrajectoryRepresentationWaypoints.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('posX', 8, false, 4, 'float[]', 5),
    new mavlink_1.MavLinkPacketField('posY', 28, false, 4, 'float[]', 5),
    new mavlink_1.MavLinkPacketField('posZ', 48, false, 4, 'float[]', 5),
    new mavlink_1.MavLinkPacketField('velX', 68, false, 4, 'float[]', 5),
    new mavlink_1.MavLinkPacketField('velY', 88, false, 4, 'float[]', 5),
    new mavlink_1.MavLinkPacketField('velZ', 108, false, 4, 'float[]', 5),
    new mavlink_1.MavLinkPacketField('accX', 128, false, 4, 'float[]', 5),
    new mavlink_1.MavLinkPacketField('accY', 148, false, 4, 'float[]', 5),
    new mavlink_1.MavLinkPacketField('accZ', 168, false, 4, 'float[]', 5),
    new mavlink_1.MavLinkPacketField('posYaw', 188, false, 4, 'float[]', 5),
    new mavlink_1.MavLinkPacketField('velYaw', 208, false, 4, 'float[]', 5),
    new mavlink_1.MavLinkPacketField('command', 228, false, 2, 'uint16_t[]', 5),
    new mavlink_1.MavLinkPacketField('validPoints', 238, false, 1, 'uint8_t'),
];
/**
...
TrajectoryRepresentationBezier.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('posY', 28, false, 4, 'float[]', 5),
    new mavlink_1.MavLinkPacketField('posZ', 48, false, 4, 'float[]', 5),
    new mavlink_1.MavLinkPacketField('delta', 68, false, 4, 'float[]', 5),
    new mavlink_1.MavLinkPacketField('posYaw', 88, false, 4, 'float[]', 5),
    new mavlink_1.MavLinkPacketField('validPoints', 108, false, 1, 'uint8_t'),
];
/**
...
CellularStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('mcc', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('mnc', 2, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('lac', 4, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('status', 6, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('failureReason', 7, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('type', 8, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('quality', 9, false, 1, 'uint8_t'),
];
/**
...
IsbdLinkStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('timestamp', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('lastHeartbeat', 8, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('failedSessions', 16, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('successfulSessions', 18, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('signalQuality', 20, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('ringPending', 21, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('txSessionPending', 22, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('rxSessionPending', 23, false, 1, 'uint8_t'),
];
/**
...
CellularConfig.FIELDS = [
    new mavlink_1.MavLinkPacketField('enableLte', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('enablePin', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('pin', 2, false, 1, 'char[]', 16),
    new mavlink_1.MavLinkPacketField('newPin', 18, false, 1, 'char[]', 16),
    new mavlink_1.MavLinkPacketField('apn', 34, false, 1, 'char[]', 32),
    new mavlink_1.MavLinkPacketField('puk', 66, false, 1, 'char[]', 16),
    new mavlink_1.MavLinkPacketField('roaming', 82, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('response', 83, false, 1, 'uint8_t'),
];
/**
...
RawRpm.FIELDS = [
    new mavlink_1.MavLinkPacketField('frequency', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('index', 4, false, 1, 'uint8_t'),
];
/**
...
UtmGlobalPosition.FIELDS = [
    new mavlink_1.MavLinkPacketField('time', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('lat', 8, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('lon', 12, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('alt', 16, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('relativeAlt', 20, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('nextLat', 24, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('nextLon', 28, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('nextAlt', 32, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('vx', 36, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('vy', 38, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('vz', 40, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('hAcc', 42, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('vAcc', 44, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('velAcc', 46, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('updateRate', 48, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('uasId', 50, false, 1, 'uint8_t[]', 18),
    new mavlink_1.MavLinkPacketField('flightState', 68, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('flags', 69, false, 1, 'uint8_t'),
];
/**
...
DebugFloatArray.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('arrayId', 8, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('name', 10, false, 1, 'char[]', 10),
    new mavlink_1.MavLinkPacketField('data', 20, true, 4, 'float[]', 58),
];
/**
...
OrbitExecutionStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('radius', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('x', 12, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('y', 16, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('z', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('frame', 24, false, 1, 'uint8_t'),
];
/**
...
SmartBatteryInfo.FIELDS = [
    new mavlink_1.MavLinkPacketField('capacityFullSpecification', 0, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('capacityFull', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('cycleCount', 8, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('weight', 10, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('dischargeMinimumVoltage', 12, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('chargingMinimumVoltage', 14, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('restingMinimumVoltage', 16, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('id', 18, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('batteryFunction', 19, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('type', 20, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('serialNumber', 21, false, 1, 'char[]', 16),
    new mavlink_1.MavLinkPacketField('deviceName', 37, false, 1, 'char[]', 50),
    new mavlink_1.MavLinkPacketField('chargingMaximumVoltage', 87, true, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('cellsInSeries', 89, true, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('dischargeMaximumCurrent', 90, true, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('dischargeMaximumBurstCurrent', 94, true, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('manufactureDate', 98, true, 1, 'char[]', 11),
];
/**
...
GeneratorStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('status', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('batteryCurrent', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('loadCurrent', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('powerGenerated', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('busVoltage', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('batCurrentSetpoint', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('runtime', 28, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('timeUntilMaintenance', 32, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('generatorSpeed', 36, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('rectifierTemperature', 38, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('generatorTemperature', 40, false, 2, 'int16_t'),
];
/**
...
ActuatorOutputStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('active', 8, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('actuator', 12, false, 4, 'float[]', 32),
];
/**
...
TimeEstimateToTarget.FIELDS = [
    new mavlink_1.MavLinkPacketField('safeReturn', 0, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('land', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('missionNextItem', 8, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('missionEnd', 12, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('commandedAction', 16, false, 4, 'int32_t'),
];
/**
...
Tunnel.FIELDS = [
    new mavlink_1.MavLinkPacketField('payloadType', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 2, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 3, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('payloadLength', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('payload', 5, false, 1, 'uint8_t[]', 128),
];
/**
...
OnboardComputerStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('uptime', 8, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('ramUsage', 12, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('ramTotal', 16, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('storageType', 20, false, 4, 'uint32_t[]', 4),
    new mavlink_1.MavLinkPacketField('storageUsage', 36, false, 4, 'uint32_t[]', 4),
    new mavlink_1.MavLinkPacketField('storageTotal', 52, false, 4, 'uint32_t[]', 4),
    new mavlink_1.MavLinkPacketField('linkType', 68, false, 4, 'uint32_t[]', 6),
    new mavlink_1.MavLinkPacketField('linkTxRate', 92, false, 4, 'uint32_t[]', 6),
    new mavlink_1.MavLinkPacketField('linkRxRate', 116, false, 4, 'uint32_t[]', 6),
    new mavlink_1.MavLinkPacketField('linkTxMax', 140, false, 4, 'uint32_t[]', 6),
    new mavlink_1.MavLinkPacketField('linkRxMax', 164, false, 4, 'uint32_t[]', 6),
    new mavlink_1.MavLinkPacketField('fanSpeed', 188, false, 2, 'int16_t[]', 4),
    new mavlink_1.MavLinkPacketField('type', 196, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('cpuCores', 197, false, 1, 'uint8_t[]', 8),
    new mavlink_1.MavLinkPacketField('cpuCombined', 205, false, 1, 'uint8_t[]', 10),
    new mavlink_1.MavLinkPacketField('gpuCores', 215, false, 1, 'uint8_t[]', 4),
    new mavlink_1.MavLinkPacketField('gpuCombined', 219, false, 1, 'uint8_t[]', 10),
    new mavlink_1.MavLinkPacketField('temperatureBoard', 229, false, 1, 'int8_t'),
    new mavlink_1.MavLinkPacketField('temperatureCore', 230, false, 1, 'int8_t[]', 8),
];
/**
...
ComponentInformation.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeBootMs', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('generalMetadataFileCrc', 4, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('peripheralsMetadataFileCrc', 8, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('generalMetadataUri', 12, false, 1, 'char[]', 100),
    new mavlink_1.MavLinkPacketField('peripheralsMetadataUri', 112, false, 1, 'char[]', 100),
];
/**
...
PlayTuneV2.FIELDS = [
    new mavlink_1.MavLinkPacketField('format', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 5, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('tune', 6, false, 1, 'char[]', 248),
];
/**
...
Event.FIELDS = [
    new mavlink_1.MavLinkPacketField('id', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('eventTimeBootMs', 4, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('sequence', 8, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('destinationComponent', 10, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('destinationSystem', 11, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('logLevels', 12, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('arguments', 13, false, 1, 'uint8_t[]', 40),
];
/**
...
CurrentEventSequence.FIELDS = [
    new mavlink_1.MavLinkPacketField('sequence', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('flags', 2, false, 1, 'uint8_t'),
];
/**
...
RequestEvent.FIELDS = [
    new mavlink_1.MavLinkPacketField('firstSequence', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('lastSequence', 2, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 5, false, 1, 'uint8_t'),
];
/**
...
ResponseEventError.FIELDS = [
    new mavlink_1.MavLinkPacketField('sequence', 0, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('sequenceOldestAvailable', 2, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 5, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('reason', 6, false, 1, 'uint8_t'),
];
/**
...
WheelDistance.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('distance', 8, false, 8, 'double[]', 16),
    new mavlink_1.MavLinkPacketField('count', 136, false, 1, 'uint8_t'),
];
/**
 * Winch status.
 */
...
WinchStatus.FIELDS = [
    new mavlink_1.MavLinkPacketField('timeUsec', 0, false, 8, 'uint64_t'),
    new mavlink_1.MavLinkPacketField('lineLength', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('speed', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('tension', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('voltage', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('current', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('status', 28, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('temperature', 32, false, 2, 'int16_t'),
];
/**
...
OpenDroneIdBasicId.FIELDS = [
    new mavlink_1.MavLinkPacketField('targetSystem', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('idOrMac', 2, false, 1, 'uint8_t[]', 20),
    new mavlink_1.MavLinkPacketField('idType', 22, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('uaType', 23, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('uasId', 24, false, 1, 'uint8_t[]', 20),
];
/**
...
OpenDroneIdLocation.FIELDS = [
    new mavlink_1.MavLinkPacketField('latitude', 0, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('longitude', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('altitudeBarometric', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('altitudeGeodetic', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('height', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('timestamp', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('direction', 24, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('speedHorizontal', 26, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('speedVertical', 28, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 30, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 31, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('idOrMac', 32, false, 1, 'uint8_t[]', 20),
    new mavlink_1.MavLinkPacketField('status', 52, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('heightReference', 53, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('horizontalAccuracy', 54, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('verticalAccuracy', 55, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('barometerAccuracy', 56, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('speedAccuracy', 57, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('timestampAccuracy', 58, false, 1, 'uint8_t'),
];
/**
...
OpenDroneIdAuthentication.MAGIC_NUMBER = 49;
OpenDroneIdAuthentication.FIELDS = [
    new mavlink_1.MavLinkPacketField('timestamp', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 4, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 5, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('idOrMac', 6, false, 1, 'uint8_t[]', 20),
    new mavlink_1.MavLinkPacketField('authenticationType', 26, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('dataPage', 27, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('pageCount', 28, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('length', 29, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('authenticationData', 30, false, 1, 'uint8_t[]', 23),
];
/**
...
OpenDroneIdSelfId.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('targetComponent', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('idOrMac', 2, false, 1, 'uint8_t[]', 20),
    new mavlink_1.MavLinkPacketField('descriptionType', 22, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('description', 23, false, 1, 'char[]', 23),
];
/**
...
OpenDroneIdSystem.PAYLOAD_LENGTH = 46;
OpenDroneIdSystem.MAGIC_NUMBER = 203;
OpenDroneIdSystem.FIELDS = [
    new mavlink_1.MavLinkPacketField('operatorLatitude', 0, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('operatorLongitude', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('areaCeiling', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('areaFloor', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('areaCount', 16, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('areaRadius', 18, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('targetSystem', 20, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 21, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('idOrMac', 22, false, 1, 'uint8_t[]', 20),
    new mavlink_1.MavLinkPacketField('operatorLocationType', 42, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('classificationType', 43, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('categoryEu', 44, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('classEu', 45, false, 1, 'uint8_t'),
];
/**
...
OpenDroneIdOperatorId.FIELDS = [
    ...
    new mavlink_1.MavLinkPacketField('targetComponent', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('idOrMac', 2, false, 1, 'uint8_t[]', 20),
    new mavlink_1.MavLinkPacketField('operatorIdType', 22, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('operatorId', 23, false, 1, 'char[]', 20),
];
/**
...
OpenDroneIdMessagePack.PAYLOAD_LENGTH = 254;
OpenDroneIdMessagePack.MAGIC_NUMBER = 62;
OpenDroneIdMessagePack.FIELDS = [
    new mavlink_1.MavLinkPacketField('targetSystem', 0, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('targetComponent', 1, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('singleMessageSize', 2, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('msgPackSize', 3, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('messages', 4, false, 1, 'uint8_t[]', 250),
];
exports.REGISTRY = {
    1: SysStatus,
    2: SystemTime,
